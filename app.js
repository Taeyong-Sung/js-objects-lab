...
game.party.push(pokemon[38], pokemon[65], pokemon[132]);
...
game.party.splice(0, 1, pokemon[39]);
game.party.splice(1, 1, pokemon[66]);
game.party.splice(2, 1, pokemon[133]);
...
call it and pass in a Pokemon object of your choice from the `pokemon` data to catch it.
...
1. Copy the `catchPokemon` method that you just wrote above, 
  and paste it below. Modify it so that it also decreases the number of 
  pokeballs in your inventory each time you catch a Pokémon.
2. How will you find and update the quantity of pokeballs in the `game.items` array?

Tips:
For this exercise, it's okay to have a negative number of pokeballs.
After updating the method, call it and pass in a Pokemon object of 
your choice from the `pokemon` data to catch it.
...
/*
Exercise 12
1. Similar to Exercise 6, now complete gyms with a difficulty below 6. 
...
property and three gym objects have a value of `false` on their `completed` property, 
